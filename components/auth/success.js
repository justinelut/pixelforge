export default function Success({ message }) {
    ...
    return (
        <div class="bg-teal-100 border-none border-teal-400 text-teal-700 px-4 py-3 rounded relative" role="alert">
            <strong class="font-bold">{message && message+" "}redirecting ...</strong>
