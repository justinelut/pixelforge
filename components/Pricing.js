            ...
            <div className="flex w-full flex-col md:flex-row">
                <div className="flex-1 flex flex-col mx-6 shadow-2xl relative bg-secondary rounded-2xl py-5 px-8 my-8 md:top-24">
                    ...
                    <div className="font-montserrat font-bold text-2xl mb-4">
                        $25<span className="font-normal text-base"> / month</span>
                    </div>
                    <div className="flex">
                        <Image
                            src="/image/logos/CheckedBox.svg"
                            alt=""
                            width={20}
                            height={20}
                            className="mr-1"
                ...
                <div className="flex-1 flex flex-col mx-6 shadow-2xl relative bg-secondary rounded-2xl py-5 px-8 my-8 md:top-12">
                    ...
                    <div className="font-montserrat font-bold text-2xl mb-4">
                        $40<span className="font-normal text-base"> / month</span>
                    </div>
                    <div className="flex">
                        <Image
                            src="/image/logos/CheckedBox.svg"
                ...
                <div className='flex-1 flex flex-col mx-6 shadow-2xl relative bg-secondary rounded-2xl py-5 px-8 my-8 md:top-24'>
                    ...
                    <div className="flex">
                        <Image src='/image/logos/CheckedBox.svg' alt="" className="mr-1" width={20} height={20} />
                        <p>Benefit #1</p>
                    </div>
                    <div className="flex">
                        <Image src='/image/logos/CheckedBox.svg' alt="" className="mr-1" width={20} height={20} />
