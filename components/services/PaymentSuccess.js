        ...
        <section className="py-10">
            <div className="container px-4 mx-auto">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <h3 className="text-2xl font-black mb-5">Your Purchase was successful</h3>
                    <p className="text-lg font-bold mb-12">Let us build for you a well-presented brand that everyone will love. while Creating a seamless digital experience for your customers.</p>
